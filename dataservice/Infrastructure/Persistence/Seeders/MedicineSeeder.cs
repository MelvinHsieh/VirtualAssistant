    ...
    internal static class MedicineSeeder
    {
        public static void SeedMedicine(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Medicine>().HasData(
                new Medicine() { Id = 1, Name = "Rosuvastatine", Indication = "Hypercholesterolemie", Dose = 10, DoseUnit = "mg", Type = "Tablet", Shape = "Vierkant", Color = "Wit" },
                new Medicine() { Id = 2, Name = "Hydrochloorthiazide", Indication = "Hypertensei", Dose = 12.5, DoseUnit = "mg", Type = "Tablet", Shape = "Rond", Color = "Rood" },
